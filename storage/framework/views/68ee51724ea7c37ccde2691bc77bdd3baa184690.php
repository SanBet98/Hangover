...
<?php $__env->startSection('titolo', 'Hangover\'s Management - Modifica Info PR'); ?>
...
<div class="container">
    ...
    <div class="row">
        ...
        <form action="anagraficaPR.php <?php echo e($parametro); ?>" method="post" style="margin-top: 2em">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hangover\resources\views/PRSection/modificaInfoPR.blade.php ENDPATH**/ ?>