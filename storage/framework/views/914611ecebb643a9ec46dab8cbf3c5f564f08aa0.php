...
<br>
        <div class="container">
            <div class="row">
                <img class="img-fluid d-block w-100" src="images/fdfe.png" alt="Hangover">
            </div>
            <br>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/FDFE/1.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 1° Edizione</h5>
                                    <p class="ombra">09/09/18 - Social Club.</p>
                                    <p></p>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <img src="images/FDFE/2.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 1° Edizione</h5>
                                    <p class="ombra">09/09/18 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/FDFE/3.jpg" class="d-block w-100" alt="...">             
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 1° Edizione</h5>
                                    <p class="ombra">09/09/18 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/FDFE/4.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 1° Edizione</h5>
                                    <p class="ombra">09/09/18 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/FDFE/5.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 1° Edizione</h5>
                                    <p class="ombra">09/09/18 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/FDFE/6.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 1° Edizione</h5>
                                    <p class="ombra">09/09/18 - Social Club.</p>
                                    <p></p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hangover\resources\views/publicSection/FDFEI.blade.php ENDPATH**/ ?>