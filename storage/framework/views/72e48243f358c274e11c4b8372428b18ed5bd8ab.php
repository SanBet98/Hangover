<?php $__env->startSection('titolo', 'Hangover\'s Management - Hangover Atto II'); ?>
...
<br>
        <div class="container">
            <div class="row">
                <img class="img-fluid d-block w-100" src="images/hangover2.png" alt="Hangover">
            </div>
            <br>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/atto2/1.jpg" class="d-block w-100" alt="...">
                            ...
                            <div class="carousel-item">
                                <img src="images/atto2/2.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Hangover Atto II</h5>
                                    <p class="ombra">03/03/18 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/atto2/3.jpg" class="d-block w-100" alt="...">             
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Hangover Atto II</h5>
                                    <p class="ombra">03/03/18 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/atto2/4.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Hangover Atto II</h5>
                                    <p class="ombra">03/03/18 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/atto2/5.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Hangover Atto II</h5>
                                    <p class="ombra">03/03/18 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/atto2/6.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Hangover Atto II</h5>
                                    <p class="ombra">03/03/18 - Social Club.</p>
                                    <p></p>
                    ...
                    <table class="table table-striped table-dark">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th scope="col">Sickness <br> B-Hood</th>
                            </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hangover\resources\views/publicSection/hangoverAttoII.blade.php ENDPATH**/ ?>