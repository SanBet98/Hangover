...
<br>
        <div class="container">
            <div class="row">
                <img class="img-fluid d-block w-100" src="images/fdfe2.png" alt="Hangover">
            </div>
            <br>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/FDFE2/1.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 2° Edizione</h5>
                                    <p class="ombra">08/09/19 - Social Club.</p>
                                    <p></p>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <img src="images/FDFE2/2.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 2° Edizione</h5>
                                    <p class="ombra">08/09/19 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/FDFE2/3.jpg" class="d-block w-100" alt="...">             
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 2° Edizione</h5>
                                    <p class="ombra">08/09/19 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/FDFE2/4.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 2° Edizione</h5>
                                    <p class="ombra">08/09/19 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/FDFE2/5.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 2° Edizione</h5>
                                    <p class="ombra">08/09/19 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/FDFE2/6.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">FDFE - 2° Edizione</h5>
                                    <p class="ombra">08/09/19 - Social Club.</p>
                                    <p></p>
                    ...
                    <table class="table table-striped table-dark">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>10q <br> Mark Andrews <br> Kintexa <br> STIGM4N <br> Wonik <br> Jacopo Bertini <br> Paolo Damiano <br> Guglielmo Lombardi <br> Gian Bettini</td>
                            </tr>
                            <tr>
                                <th scope="col">Voice</th>
                                <td>Enzo Bettari <br> Miky Remmi</td>
                            </tr>
                            <tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hangover\resources\views/publicSection/FDFE2.blade.php ENDPATH**/ ?>