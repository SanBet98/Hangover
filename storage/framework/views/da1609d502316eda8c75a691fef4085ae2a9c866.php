...
<br>
        <div class="container">
            <div class="row">
                <img class="img-fluid d-block w-100" src="images/carnival.png" alt="Hangover">
            </div>
            <br>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/Carnival/1.jpg" class="d-block w-100" alt="...">
                            ...
                            <div class="carousel-item">
                                <img src="images/Carnival/2.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Carnival Party</h5>
                                    <p class="ombra">03/03/19 - Circus Beatclub.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/Carnival/3.jpg" class="d-block w-100" alt="...">             
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Carnival Party</h5>
                                    <p class="ombra">03/03/19 - Circus Beatclub.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/Carnival/4.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Carnival Party</h5>
                                    <p class="ombra">03/03/19 - Circus Beatclub.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/Carnival/5.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Carnival Party</h5>
                                    <p class="ombra">03/03/19 - Circus Beatclub.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/Carnival/6.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Carnival Party</h5>
                                    <p class="ombra">03/03/19 - Circus Beatclub.</p>
                                    <p></p>
                    ...
                    <table class="table table-striped table-dark">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Circus Beatclub</td>
                            </tr>

                            <tr>
                                <th scope="col">Resident DJs</th>
                                <td>10q <br> Mark Andrews <br> Kintexa <br> Jacopo Bertini <br> Paolo Damiano <br> Guglielmo Lombardi <br> Gian Bettini</td>
                            </tr>
                            <tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hangover\resources\views/publicSection/carnival.blade.php ENDPATH**/ ?>