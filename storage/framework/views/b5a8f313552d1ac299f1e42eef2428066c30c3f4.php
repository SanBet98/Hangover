...
<?php $__env->startSection('titolo', 'Hangover\'s Management - Hangover Atto VI'); ?>
...
<?php $__env->startSection('corpo'); ?>
 <br>
        <div class="container">
           <div class="row">
                <img class="img-fluid d-block w-100" src="images/hangover6.png" alt="Hangover">
            </div>
            <br>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/atto6/1.jpg" class="d-block w-100" alt="...">
                            ...
                            <div class="carousel-item">
                                <img src="images/atto6/2.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Hangover Atto VI</h5>
                                    <p class="ombra">11/05/19 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/atto6/3.jpg" class="d-block w-100" alt="...">             
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Hangover Atto VI</h5>
                                    <p class="ombra">11/05/19 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/atto6/4.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Hangover Atto VI</h5>
                                    <p class="ombra">11/05/19 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/atto6/5.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Hangover Atto VI</h5>
                                    <p class="ombra">11/05/19 - Social Club.</p>
                                    <p></p>
                            ...
                            <div class="carousel-item">
                                <img src="images/atto6/6.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="ombra">Hangover Atto VI</h5>
                                    <p class="ombra">11/05/19 - Social Club.</p>
                                    <p></p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hangover\resources\views/publicSection/hangoverAttoVI.blade.php ENDPATH**/ ?>